  ...
  return (
    <main className="page">
      ...
      <div className="wrap">
        ...
        <div className="sub">Ваши консультации</div>

        <div className="card">
          <div className="muted">
            Этот раздел готов по UI и маршрутам.
            <br />
            Скинь код/роуты для консультаций — подключу API так же, как в “Вопросах” и “Истории операций”.
          </div>
