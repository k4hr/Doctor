/* path: app/api/profile/consultations/[id]/route.ts */
...
export async function GET(req: Request, ctx: { params: { id: string } }) {
  try {
      ...
      select: {
        ...
        doctor: {
          select: {
            ...
            telegramId: true, // не отдаём наружу, просто на будущее
          },
        },
    ...
    return NextResponse.json(
      { ok: false, error: 'FAILED_DETAIL', hint: String(e?.message || 'See logs') },
      { status: 500 }
    );
  }
}
